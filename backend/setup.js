...
db.serialize(() => {
    ...
    db.run(`CREATE TABLE IF NOT EXISTS pix_links (
        id INTEGER PRIMARY KEY AUTOINCREMENT,
        payment_id INTEGER NOT NULL,
    ...
    db.get('SELECT COUNT(*) as count FROM customers', (err, row) => {
        ...
        if (row.count === 0) {
            ...
            `, function(err) {
                ...
                // Inserir payments
                db.run(`INSERT INTO payments (customer_id, amount, due_date, status, description, paid_at) VALUES
            ...
            console.log('  ℹ Customers já existem, pulando inserção');
        }
    });
});
